...
export default async function signWhitelist(
  ...
  // https://github.com/OwnrsXYZ/priority-pass/blob/main/contracts/EIP712Whitelisting.sol#L33-L43
  const domain = {
    name: "OwnrsWhitelistToken",
    version: "1",
    chainId,
  ...
  // https://github.com/OwnrsXYZ/priority-pass/blob/main/contracts/EIP712Whitelisting.sol#L27-L28
  const types = {
