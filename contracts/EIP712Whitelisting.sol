...
contract EIP712Whitelisting is Ownable {
    ...
    // https://github.com/OwnrsXYZ/priority-pass/blob/main/test/signWhitelist.ts#L22
    bytes32 public constant MINTER_TYPEHASH =
        keccak256("Minter(address wallet)");

    constructor() {
        // This should match whats in the client side whitelist signing code
        // https://github.com/OwnrsXYZ/priority-pass/blob/main/test/signWhitelist.ts#L12
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                keccak256(bytes("OwnrsWhitelistToken")),
                keccak256(bytes("1")),
                block.chainid,
                address(this)
            )
